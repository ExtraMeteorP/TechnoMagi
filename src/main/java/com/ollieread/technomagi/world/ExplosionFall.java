package com.ollieread.technomagi.world;
...
public class ExplosionFall extends Explosion
{
    ...
    public ExplosionFall(World par1World, Entity par2Entity, double par3, double par5, double par7, float par9)
    {
    ...
    public void doExplosionA()
    {
        ...
        for (int i1 = 0; i1 < list.size(); ++i1) {
            ...
            if (entity instanceof EntityPlayer && entity.equals(exploder)) {
                continue;
            }
    ...
    public void doExplosionB(boolean par1)
    {
        if (this.explosionSize >= 2.0F && this.isSmoking) {
            ...
            this.worldObj.playSoundEffect(this.explosionX, this.explosionY, this.explosionZ, "damage.fallbig", 4.0F, (1.0F + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 0.2F) * 0.7F);
        } else {
            this.worldObj.spawnParticle("largeexplode", this.explosionX, this.explosionY, this.explosionZ, 1.0D, 0.0D, 0.0D);
            this.worldObj.playSoundEffect(this.explosionX, this.explosionY, this.explosionZ, "damage.fallsmall", 4.0F, (1.0F + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 0.2F) * 0.7F);
        }
