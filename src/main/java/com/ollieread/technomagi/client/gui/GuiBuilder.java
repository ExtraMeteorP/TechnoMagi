...
public class GuiBuilder extends Gui
{
    ...
    public GuiBuilder setOffset(int screenWidth, int screenHeight)
    {
    ...
    public GuiBuilder setBackgroundDimensions(int width, int height)
    {
        this.bgWidth = width;
    ...
    public GuiBuilder setDimensions(int width, int height)
    {
        this.width = width;
        this.height = height;
    ...
    public GuiBuilder setHeading(String heading)
    {
    ...
    public GuiBuilder setMouse(int x, int y)
    {
        this.mouseX = x;
        this.mouseY = y;
    ...
    public GuiBuilder addElement(IGuiElement element)
    {
    ...
    public GuiBuilder resetElements()
    {
        elements = new LinkedHashMap<String, IGuiElement>();
        buttonIds = -1;
    ...
    public void drawElementBackgrounds()
    {
        ...
        for (IGuiElement element : elements.values()) {
            element.drawBackground(this, x, y);
        }
    }
    ...
    public void hover(int xPosition, int yPosition)
    {
        ...
        for (IGuiElement element : elements.values()) {
            if (element.hover(this, x, y, xPosition, yPosition)) {
                break;
            }
        }
    }

    public IGuiElement clicked(int xPosition, int yPosition)
    {
        int x = xOffset + 3;
        int y = yOffset + 24;

        for (IGuiElement element : elements.values()) {
            IGuiElement link = element.clicked(this, x, y, xPosition, yPosition);
    ...
    public void drawBackground()
    {
        ...
        tessellator.addVertex((double) xOffset, (double) yOffset + bgHeight, 0.0D);
        tessellator.addVertex((double) xOffset + bgWidth, (double) yOffset + bgHeight, 0.0D);
        tessellator.addVertex((double) xOffset + bgWidth, (double) yOffset, 0.0D);
    ...
    public void drawStretchedRect(int x, int y, int u, int v, int ow, int oh, int w, int h)
    {
        ...
        Tessellator tessellator = Tessellator.instance;
        tessellator.startDrawingQuads();
        tessellator.addVertexWithUV((double) (x + 0), (double) (y + h), (double) zLevel, (double) ((float) (u + 0) * f), (double) ((float) (v + oh) * f1));
        tessellator.addVertexWithUV((double) (x + w), (double) (y + h), (double) zLevel, (double) ((float) (u + ow) * f), (double) ((float) (v + oh) * f1));
        tessellator.addVertexWithUV((double) (x + w), (double) (y + 0), (double) zLevel, (double) ((float) (u + ow) * f), (double) ((float) (v + 0) * f1));
