...
public class TileEntityMachineInfuserRenderer extends TileEntitySpecialRenderer
{

    private final ModelMachineConstruct construct;
    private final ModelMachineInfuser focuser;
    ...
    public TileEntityMachineInfuserRenderer()
    {
        construct = new ModelMachineConstruct();
        focuser = new ModelMachineInfuser();
    }

    @Override
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float partialTicks)
    {
        TileEntityMachineInfuser machine = (TileEntityMachineInfuser) te;
