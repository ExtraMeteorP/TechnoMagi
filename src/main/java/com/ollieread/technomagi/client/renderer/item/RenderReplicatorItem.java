...
public class RenderReplicatorItem implements IItemRenderer
{
    ...
    protected ModelMachineReplicator model;
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data)
    {
        ...
        GL11.glPushMatrix();
        Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(Reference.MODID.toLowerCase(), "textures/blocks/modelReplicator.png"));
