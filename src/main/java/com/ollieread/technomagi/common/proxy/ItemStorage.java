...
public class ItemStorage
{
    ...
    public ItemStorage(int max)
    {
        this(max, 0, null);
    }

    public ItemStorage(int max, int total)
    {
        this(max, total, null);
    }

    public ItemStorage(int max, int total, NBTTagCompound nbt)
    {
        capacity = max;
        amount = total;
    ...
    public ItemStorage readFromNBT(NBTTagCompound nbt)
    {
        if (!nbt.hasKey("Empty")) {
