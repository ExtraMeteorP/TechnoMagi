...
public class BetterResources extends Knowledge
{
    ...
    public BetterResources()
    {
        ...
        // scanIronOre = TechnomagiApi.addResearch("scan_iron_ore",
        // getName()).setProgress(2).setChance(4).setRepetition(3); // 6
        // scanCopperOre = TechnomagiApi.addResearch("scan_copper_ore",
        // getName()).setProgress(2).setChance(4).setRepetition(3); // 6

        mineIronOre = TechnomagiApi.addResearch("mine_iron_ore", getName()).setProgress(2).setChance(16).setRepetition(6); // 12
        mineCopperOre = TechnomagiApi.addResearch("mine_copper_ore", getName()).setProgress(2).setChance(10).setRepetition(6); // 12
        ...
        smeltIronIngot = TechnomagiApi.addResearch("smelt_iron_ingot", getName()).setProgress(2).setChance(12).setRepetition(5); // 10
        smeltCopperIngot = TechnomagiApi.addResearch("smelt_copper_ingot", getName()).setProgress(2).setChance(10).setRepetition(5); // 10
        ...
        // scanIronBlock = TechnomagiApi.addResearch("scan_iron_block",
        // getName()).setProgress(2).setChance(4).setRepetition(3); // 6
        // scanCopperBlock = TechnomagiApi.addResearch("scan_copper_block",
        // getName()).setProgress(2).setChance(4).setRepetition(3); // 6
    ...
    public void mappings()
    {
        ...
        // TechnomagiApi.scan().addScanMapping(BlockHelper.getBlockRepresentation(Blocks.iron_ore,
        // 0), scanIronOre.getName());
        ...
        // TechnomagiApi.scan().addScanMapping(BlockHelper.getBlockRepresentation(Blocks.iron_block,
        // 0), scanIronBlock.getName());
        // TechnomagiApi.scan().addScanMapping(BlockHelper.getBlockRepresentation(com.ollieread.technomagi.common.init.Blocks.resource,
        // 4), scanCopperBlock.getName());
