...
public class EnergyLight extends Knowledge
{
    ...
    public static Research analyseGlowstone;
    ...
    public EnergyLight()
    {
        ...
        // scanFlower = TechnomagiApi.addResearch("scan_flower",
        // getName()).setProgress(5).setChance(4).setRepetition(2); // 10
        analyseFlower = TechnomagiApi.addResearch("analyse_flower", getName()).setProgress(6).setChance(4).setRepetition(2); // 12
        // witnessCropGrow = TechnomagiApi.addResearch("witness_crop_grow",
        // getName()).setProgress(4).setChance(4).setRepetition(2); // 8
        witnessTreeGrow = TechnomagiApi.addResearch("witness_tree_grow", getName()).setProgress(4).setChance(4).setRepetition(4); // 16
        // scanFire = TechnomagiApi.addResearch("scan_fire",
        // getName()).setProgress(6).setChance(2); // 5
        analyseGlowstone = TechnomagiApi.addResearch("analyse_glowstone", getName()).setProgress(8).setChance(2); // 16
        analyseGlowstoneDust = TechnomagiApi.addResearch("analyse_glowstone_dust", getName()).setProgress(4).setChance(4).setRepetition(2); // 8
    }
    ...
    public void mappings()
    {
        ...
        // TechnomagiApi.scan().addScanMapping(BlockHelper.getBlockRepresentation(Blocks.red_flower,
        // -1), scanFlower.getName());
        ...
        // TechnomagiApi.scan().addScanMapping(BlockHelper.getBlockRepresentation(Blocks.fire,
        // 0), scanFire.getName());
        TechnomagiApi.scan().addAnalysisMapping(ItemStackHelper.getItemStackRepresentation(ItemStackHelper.block("glowstone", 1, -1)), analyseGlowstone.getName());
