...
public class BasicResources extends Knowledge
{
    ...
    public BasicResources()
    {
        ...
        scanLog = TechnomagiApi.addResearch("scan_log", getName()).setProgress(5).setChance(12).setRepetition(1);
        scanStone = TechnomagiApi.addResearch("scan_stone", getName()).setProgress(5).setChance(12).setRepetition(1);
