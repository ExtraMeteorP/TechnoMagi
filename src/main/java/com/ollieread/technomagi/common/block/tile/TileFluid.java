...
public class TileFluid extends TileBase implements IFluidHandler
{

    protected FluidTank tank;

    public TileFluid(int volume)
    {
    ...
    {
        if (getFluid().equals(resource) && (getFluidAmount() + resource.amount) < getCapacity()) {
            return true;
        }
