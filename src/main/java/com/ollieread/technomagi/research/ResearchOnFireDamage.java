...
public class ResearchOnFireDamage extends Research
{

    public ResearchOnFireDamage(String name, String knowledge, int progress)
    {
    ...
    public int getEvent()
    {
        return ResearchEvents.EVENT_ON_FIRE;
    }
