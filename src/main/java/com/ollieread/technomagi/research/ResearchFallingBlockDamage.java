...
public class ResearchFallingBlockDamage extends Research
{

    public ResearchFallingBlockDamage(String name, String knowledge, int progress)
    {
    ...
    public int getEvent()
    {
        return ResearchEvents.EVENT_FALLING_BLOCK;
    }
