...
public class ResearchCraftingDiamondAxe extends Research implements IResearchCrafting
{

    public ResearchCraftingDiamondAxe(String name, String knowledge, int progress)
    {
