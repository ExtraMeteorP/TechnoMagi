...
public class ResearchCraftingIronShovel extends Research implements IResearchCrafting
{

    public ResearchCraftingIronShovel(String name, String knowledge, int progress)
    {
