...
public class ResearchCraftingIronAxe extends Research implements IResearchCrafting
{

    public ResearchCraftingIronAxe(String name, String knowledge, int progress)
    {
