...
public class ResearchSmeltingGoldIngot extends Research implements IResearchCrafting
{

    public ResearchSmeltingGoldIngot(String name, String knowledge, int progress)
    {
