...
public class ResearchCraftingStonePickaxe extends Research implements IResearchCrafting
{

    public ResearchCraftingStonePickaxe(String name, String knowledge, int progress)
    {
