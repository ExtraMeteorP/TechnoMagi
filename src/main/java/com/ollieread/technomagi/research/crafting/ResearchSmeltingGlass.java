...
public class ResearchSmeltingGlass extends Research implements IResearchCrafting
{

    public ResearchSmeltingGlass(String name, String knowledge, int progress)
    {
    ...
    {
        return new ItemStack(net.minecraft.init.Blocks.glass);
    }
