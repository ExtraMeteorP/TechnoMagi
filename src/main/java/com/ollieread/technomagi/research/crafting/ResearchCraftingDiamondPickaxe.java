...
public class ResearchCraftingDiamondPickaxe extends Research implements IResearchCrafting
{

    public ResearchCraftingDiamondPickaxe(String name, String knowledge, int progress)
    {
