...
public class ResearchCraftingStoneShovel extends Research implements IResearchCrafting
{

    public ResearchCraftingStoneShovel(String name, String knowledge, int progress)
    {
