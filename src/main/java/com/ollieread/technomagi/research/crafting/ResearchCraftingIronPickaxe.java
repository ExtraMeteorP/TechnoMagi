...
public class ResearchCraftingIronPickaxe extends Research implements IResearchCrafting
{

    public ResearchCraftingIronPickaxe(String name, String knowledge, int progress)
    {
