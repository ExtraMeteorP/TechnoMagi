...
public class ResearchCraftingFurnace extends Research implements IResearchCrafting
{

    public ResearchCraftingFurnace(String name, String knowledge, int progress)
    {
    ...
    {
        return new ItemStack(net.minecraft.init.Blocks.furnace);
    }
