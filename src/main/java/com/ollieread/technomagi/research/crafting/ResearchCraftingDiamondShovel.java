...
public class ResearchCraftingDiamondShovel extends Research implements IResearchCrafting
{

    public ResearchCraftingDiamondShovel(String name, String knowledge, int progress)
    {
