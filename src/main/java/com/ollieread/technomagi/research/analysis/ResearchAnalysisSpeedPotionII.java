...
public class ResearchAnalysisSpeedPotionII extends ResearchAnalysis
{

    public ResearchAnalysisSpeedPotionII(String name, String knowledge, int progress, int chance, List items)
    {
