...
public class ResearchEventDamageAnvil extends Research implements IResearchEvent
{

    public ResearchEventDamageAnvil(String name, String knowledge, int progress)
    {
