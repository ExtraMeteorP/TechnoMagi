...
public class ResearchEventKnowledgeCow extends Research implements IResearchEvent
{

    public ResearchEventKnowledgeCow(String name, String knowledge, int progress)
    {
