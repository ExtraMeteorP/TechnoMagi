...
public class ResearchEventKnowledgeSheep extends Research implements IResearchEvent
{

    public ResearchEventKnowledgeSheep(String name, String knowledge, int progress)
    {
