...
public class ResearchEventUseFlintAndSteel extends Research implements IResearchEvent
{

    public ResearchEventUseFlintAndSteel(String name, String knowledge, int progress)
    {
