...
public class ResearchEventDamageStarve extends Research implements IResearchEvent
{

    public ResearchEventDamageStarve(String name, String knowledge, int progress)
    {
