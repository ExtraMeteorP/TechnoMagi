...
public class ResearchEventKnowledgeProgress extends Research implements IResearchEvent
{

    public ResearchEventKnowledgeProgress(String name, String knowledge, int progress)
    {
