...
public class ResearchEventKnowledgeChicken extends Research implements IResearchEvent
{

    public ResearchEventKnowledgeChicken(String name, String knowledge, int progress)
    {
