...
public class ResearchEventDamageOnFire extends Research implements IResearchEvent
{

    public ResearchEventDamageOnFire(String name, String knowledge, int progress)
    {
