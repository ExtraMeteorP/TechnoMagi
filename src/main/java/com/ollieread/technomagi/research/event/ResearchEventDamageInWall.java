...
public class ResearchEventDamageInWall extends Research implements IResearchEvent
{

    public ResearchEventDamageInWall(String name, String knowledge, int progress)
    {
