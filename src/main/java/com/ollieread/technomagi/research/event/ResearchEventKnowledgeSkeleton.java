...
public class ResearchEventKnowledgeSkeleton extends Research implements IResearchEvent
{

    public ResearchEventKnowledgeSkeleton(String name, String knowledge, int progress)
    {
    ...
    {
        return "knowledgeEntitySkeleton";
    }
