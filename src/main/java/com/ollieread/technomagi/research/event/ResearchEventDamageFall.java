...
public class ResearchEventDamageFall extends Research implements IResearchEvent
{

    public ResearchEventDamageFall(String name, String knowledge, int progress)
    {
