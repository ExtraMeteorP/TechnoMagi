...
public class ResearchEventSpecialised extends Research implements IResearchEvent
{

    public ResearchEventSpecialised(String name, String knowledge, int progress)
    {
