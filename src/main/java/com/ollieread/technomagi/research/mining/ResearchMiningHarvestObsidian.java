...
public class ResearchMiningHarvestObsidian extends Research implements IResearchMining
{

    public ResearchMiningHarvestObsidian(String name, String knowledge, int progress)
    {
