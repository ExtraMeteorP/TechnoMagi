...
public class ResearchMiningHarvestDiamondOre extends Research implements IResearchMining
{

    public ResearchMiningHarvestDiamondOre(String name, String knowledge, int progress)
    {
