...
public class ResearchMiningHarvestIronOre extends Research implements IResearchMining
{

    public ResearchMiningHarvestIronOre(String name, String knowledge, int progress)
    {
