...
public class ResearchDensityHarvestObsidian extends Research implements IResearchMining
{

    public ResearchDensityHarvestObsidian(String name, String knowledge, int progress)
    {
