...
public class PlayerAbilities extends ExtendedProperties {
	...
	/**
	 * A list of passive abilities currently available to the player. This is not stored in NBT but is generated
	 * when a change or update to researched knowledge takes place.
	 */
	private List<String> passiveAbilityList = new ArrayList<String>();
	/**
	 * A list of active abilities currently available to the player. This is not stored in NBT but is generated
	 * when a change or update to researched knowledge takes place.
	 */
