...
public class KnowledgeEthologyPassive extends Knowledge
{
     ...
     * @param category
     */
    public KnowledgeEthologyPassive(String name, String Modid, String[] knowledge, String category)
    {
     ...
     * @param category
     */
    public KnowledgeEthologyPassive(String name, ResourceLocation icon, String[] knowledge, String category)
    {
