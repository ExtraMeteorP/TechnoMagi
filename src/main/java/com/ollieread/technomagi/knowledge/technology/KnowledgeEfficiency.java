...
public class KnowledgeEfficiency extends Knowledge
{
     ...
     * @param category
     */
    public KnowledgeEfficiency(String name, String Modid, String[] knowledge, String category)
    {
     ...
     * @param category
     */
    public KnowledgeEfficiency(String name, ResourceLocation icon, String[] knowledge, String category)
    {
