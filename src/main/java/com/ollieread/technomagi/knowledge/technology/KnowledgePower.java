...
public class KnowledgePower extends Knowledge
{
     ...
     * @param category
     */
    public KnowledgePower(String name, String Modid, String[] knowledge, String category)
    {
     ...
     * @param category
     */
    public KnowledgePower(String name, ResourceLocation icon, String[] knowledge, String category)
    {
