...
public class GenerationHelper
{
     ...
     * @return
     */
    public static List<ChunkPosition> getSphere(Vec3 pos, World world, double radiusX, double radiusY, double radiusZ, boolean filled)
    {
        ...
        List<ChunkPosition> affectedBlocks = new ArrayList();
        affectedBlocks.addAll(hashset);

        return affectedBlocks;
    }

    public static List getCylinder(Vec3 pos, World world, double radiusX, double height, double radiusZ, boolean filled)
    {
        HashSet hashset = new HashSet();
