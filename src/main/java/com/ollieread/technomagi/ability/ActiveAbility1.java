...
public class ActiveAbility1 extends AbilityActive {

	public ActiveAbility1(String name) {
		super(name);
	}
	...
	public void use(PlayerKnowledge charon)
	{
		...
		if(charon.decreaseNanites(5)) {
			player.addChatComponentMessage(new ChatComponentText("You used ability 1"));
		} else {
			player.addChatComponentMessage(new ChatComponentText("You couldn't use ability 1"));
		}
	}
