...
public class ActiveAbility6 extends AbilityActive {

	public ActiveAbility6(String name) {
		super(name);
	}
	...
	public void use(PlayerKnowledge charon)
	{
		...
		if(charon.decreaseNanites(5)) {
			player.addChatComponentMessage(new ChatComponentText("You used ability 6"));
		} else {
			player.addChatComponentMessage(new ChatComponentText("You couldn't use ability 6"));
		}
	}
