...
public class ActiveAbility2 extends AbilityActive {

	public ActiveAbility2(String name) {
		super(name);
	}
	...
	public void use(PlayerKnowledge charon)
	{
		...
		if(charon.decreaseNanites(5)) {
			player.addChatComponentMessage(new ChatComponentText("You used ability 2"));
		} else {
			player.addChatComponentMessage(new ChatComponentText("You couldn't use ability 2"));
		}
	}
