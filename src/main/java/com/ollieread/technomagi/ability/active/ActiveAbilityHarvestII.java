...
public class ActiveAbilityHarvestII extends AbilityActive
{

    public ActiveAbilityHarvestII(String name)
    {
    ...
    public boolean use(ExtendedPlayerKnowledge charon, Event event)
    {
        if (event instanceof PlayerInteractEvent) {
            ...
            if (interact.action.equals(Action.RIGHT_CLICK_BLOCK)) {
                ...
                if (block.getHarvestLevel(meta) <= 2 && (block.getHarvestTool(meta).equals("pickaxe") || block.getHarvestTool(meta).equals("shovel"))) {
