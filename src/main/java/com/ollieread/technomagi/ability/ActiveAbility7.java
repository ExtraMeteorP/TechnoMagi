...
public class ActiveAbility7 extends AbilityActive {

	public ActiveAbility7(String name) {
		super(name);
	}
	...
	public void use(PlayerKnowledge charon)
	{
		...
		if(charon.decreaseNanites(5)) {
			player.addChatComponentMessage(new ChatComponentText("You used ability 7"));
		} else {
			player.addChatComponentMessage(new ChatComponentText("You couldn't use ability 7"));
		}
	}
