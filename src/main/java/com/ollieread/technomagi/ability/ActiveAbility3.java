...
public class ActiveAbility3 extends AbilityActive {

	public ActiveAbility3(String name) {
		super(name);
	}
	...
	public void use(PlayerKnowledge charon)
	{
		...
		if(charon.decreaseNanites(5)) {
			player.addChatComponentMessage(new ChatComponentText("You used ability 3"));
		} else {
			player.addChatComponentMessage(new ChatComponentText("You couldn't use ability 3"));
		}
	}
