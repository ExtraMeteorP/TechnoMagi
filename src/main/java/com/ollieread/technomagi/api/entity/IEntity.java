...
public interface IEntity
{
    ...
    /**
     * This interface should be used alongside {@link IEntity} for entities that
     * should drop a brain.
     * 
     * @author ollieread
     *
    ...
    public static interface IEntityBrain
    {
         ...
         * @return
         */
        public int getPreservedMultiplier();
    ...
    /**
     * This interface should be used alongside {@link IEntity} for entities that
     * can yield blood samples, meaning they can be affected by the targeted
     * nanites. This should only be used for entities that are capable of having
    ...
    /**
     * This interface should be used alongside {@link IEntity} for entities that
     * can have their own internal nanites, which would be used for research.
     * 
