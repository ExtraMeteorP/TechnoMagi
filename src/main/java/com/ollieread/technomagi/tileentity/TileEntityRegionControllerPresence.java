...
import com.ollieread.technomagi.tileentity.component.ComponentRegionPresence;
import com.ollieread.technomagi.world.region.RegionPayload;

public class TileEntityRegionControllerPresence extends TileEntityRegionController implements ITileEntityRegionController
{

    public TileEntityRegionControllerPresence()
    {
        super(0, 0, 0);

        setController(new ComponentRegionPresence(this));
    }
