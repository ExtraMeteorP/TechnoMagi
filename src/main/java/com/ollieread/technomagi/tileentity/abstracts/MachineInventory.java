...
public abstract class MachineInventory extends Machine implements IInventory
{

    protected Inventory inventory = null;

    public MachineInventory(int capacity, int maxReceive, int maxExtract, IInventory inventory)
    {
