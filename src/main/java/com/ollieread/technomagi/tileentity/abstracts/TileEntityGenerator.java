...
public abstract class TileEntityGenerator extends TileEntityBasic implements IEnergyHandler
{

    protected ComponentPower energy = null;
    public int energyGeneration = 0;
    public int energyTicks = 0;
    public int working = 0;

    public TileEntityGenerator(int capacity, int maxExtract, int generation, int ticks)
    {
        energy = new ComponentPower(capacity, 0, maxExtract);
