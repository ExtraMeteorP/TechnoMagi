...
public class TileEntityMachineStorage extends TileEntityBasic implements ITileEntityStorage
{
    protected ComponentStorage storage = new ComponentStorage(4096);
