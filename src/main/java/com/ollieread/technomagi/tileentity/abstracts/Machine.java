...
public abstract class Machine extends Basic implements ITileEntityMachine
{

    protected Power energy;
    ...
    public Machine(int capacity, int maxTransfer)
    {
        this(capacity, maxTransfer, maxTransfer);
    }

    public Machine(int capacity, int maxReceive, int maxExtract)
    {
        energy = new Power(capacity, maxReceive, maxExtract);
        owner = new Owner();
    }
