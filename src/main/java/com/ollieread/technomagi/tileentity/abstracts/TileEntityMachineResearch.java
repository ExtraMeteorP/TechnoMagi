...
public abstract class TileEntityMachineResearch extends TileEntityMachineInventory implements IResearchMachine
{
    ...
    public TileEntityMachineResearch(int capacity, int maxReceive, int maxExtract, int maxData, IInventory inventory)
    {
