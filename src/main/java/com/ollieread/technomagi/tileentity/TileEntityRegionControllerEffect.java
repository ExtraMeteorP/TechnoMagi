...
import com.ollieread.technomagi.tileentity.component.ComponentRegionEffect;
import com.ollieread.technomagi.world.region.RegionPayload;

public class TileEntityRegionControllerEffect extends TileEntityRegionController implements ITileEntityRegionController
{

    public TileEntityRegionControllerEffect()
    {
        super(0, 0, 0);

        setController(new ComponentRegionEffect(this));
    }
