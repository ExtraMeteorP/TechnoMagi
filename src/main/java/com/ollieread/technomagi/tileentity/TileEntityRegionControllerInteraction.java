...
import com.ollieread.technomagi.tileentity.component.ComponentRegionInteraction;
import com.ollieread.technomagi.world.region.RegionPayload;

public class TileEntityRegionControllerInteraction extends TileEntityRegionController implements ITileEntityRegionController
{

    public TileEntityRegionControllerInteraction()
    {
        super(0, 0, 0);

        setController(new ComponentRegionInteraction(this));
    }
