...
import com.ollieread.technomagi.tileentity.ITileEntityHasMaster;

import net.minecraft.nbt.NBTTagCompound;

public class ComponentMasterBlock implements ITileEntityHasMaster
{
    ...
    public ComponentMasterBlock(boolean setup)
    {
        this.setup = setup;
    }
