...
public class ComponentPower implements IEnergyHandler
{

    protected EnergyStorage storage;

    public ComponentPower(int capacity)
    {
        this(capacity, capacity, capacity);
    }

    public ComponentPower(int capacity, int maxTransfer)
    {
        this(capacity, maxTransfer, maxTransfer);
    }

    public ComponentPower(int capacity, int maxReceive, int maxExtract)
    {
