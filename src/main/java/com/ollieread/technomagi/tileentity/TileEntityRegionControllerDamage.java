...
import com.ollieread.technomagi.tileentity.component.ComponentRegionDamage;
import com.ollieread.technomagi.world.region.RegionPayload;

public class TileEntityRegionControllerDamage extends TileEntityRegionController implements ITileEntityRegionController
{

    public TileEntityRegionControllerDamage()
    {
        super(0, 0, 0);

        setController(new ComponentRegionDamage(this));
    }
